<%@page import="craft.model.Etat"%>
<%@page import="java.io.PrintWriter"%>
<%@page import="craft.service.CommandeDAO"%>
<%@page import="craft.service.ArticleDAO"%>
<%@page import="craft.service.ClientDAO"%>
<%@page import="craft.model.Article"%>
